...
farm_profile_2023 <-
  ...
  filter(year(mdy(`Collection Date`)) == "2023")
...
land_tenure_count %>%
  ...
  geom_text(aes(y = n * 0.65 + c(0, cumsum(n)[-length(n)]), 
            ...
            color = "black", size = 4) +
  labs(title = "Pie Graph on Ownership of Land - 2023 Farmer's Profile",
       fill = "Types of Ownership") + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
ggsave(path = "../farm_profile_2023", filename = "Types of Ownership of Land.png")
...
topography_count %>%
  ...
  geom_text(aes(y = n * 0.4 + c(0, cumsum(n)[-length(n)]), 
            ...
            color = "black", size = 4) +
  labs(title = "Topography Distribution - 2023 Farmer's Profile",
       fill = "Types of Topography") + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 
ggsave(path = "../farm_profile_2023", filename = "Types of Topography.png")
...
soil_texture_count %>%
  ...
  labs(title = "Soil Texture - 2023 Farmer's Profiles",
       fill = "Types of Soil Texture") + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) 
ggsave(path = "../farm_profile_2023", filename = "Types of Soil Texture.png")
```
...
fertilizer_level_count %>%
  ...
  labs(title = "Fertilizer Application Level - 2023 Farmer's Profiles",
       fill = "Types of Fertilizer Application Level") + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
ggsave(path = "../farm_profile_2023", filename = "Types of Fertilizer Application Level.png")
```
