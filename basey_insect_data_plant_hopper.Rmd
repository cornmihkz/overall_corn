---
title: "basey_insect_data_plant_hopper"
...
hopper_df_basey <- 
  ...
  filter(Municipality == "Basey")

# convert date format
hopper_df_basey$collect_date <- 
  as.Date(hopper_df_basey$`Collection Date`, "%B %d, %Y")
...
hopper_joined_basey$Variety %>% unique()
```
...
```{r}
cor.test(as.numeric(hopper_basey_rank_df$Mode_class_infest_hopper), as.numeric(hopper_basey_rank_df$rank_mean_temp), method="kendall")
```